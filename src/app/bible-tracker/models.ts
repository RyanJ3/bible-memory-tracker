...
export const BIBLE_DATA: { [key: string]: BibleBook } = {
  ...
  Romans: new BibleBook("New Testament", "Romans", "Epistles", [32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33, 27], 45, ["Protestant", "Catholic", "Orthodox"]),
  "1 Corinthians": new BibleBook("New Testament", "1 Corinthians", "Epistles", [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24], 46, ["Protestant", "Catholic", "Orthodox"]),
  "2 Corinthians": new BibleBook("New Testament", "2 Corinthians", "Epistles", [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14], 47, ["Protestant", "Catholic", "Orthodox"]),
  Galatians: new BibleBook("New Testament", "Galatians", "Epistles", [24, 21, 29, 31, 26, 18], 48, ["Protestant", "Catholic", "Orthodox"]),
  Ephesians: new BibleBook("New Testament", "Ephesians", "Epistles", [23, 22, 21, 32, 33, 24], 49, ["Protestant", "Catholic", "Orthodox"]),
  Philippians: new BibleBook("New Testament", "Philippians", "Epistles", [30, 30, 21, 23], 50, ["Protestant", "Catholic", "Orthodox"]),
  Colossians: new BibleBook("New Testament", "Colossians", "Epistles", [29, 23, 25, 18], 51, ["Protestant", "Catholic", "Orthodox"]),
  "1 Thessalonians": new BibleBook("New Testament", "1 Thessalonians", "Epistles", [10, 20, 13, 18, 28], 52, ["Protestant", "Catholic", "Orthodox"]),
  "2 Thessalonians": new BibleBook("New Testament", "2 Thessalonians", "Epistles", [12, 17, 18], 53, ["Protestant", "Catholic", "Orthodox"]),
  "1 Timothy": new BibleBook("New Testament", "1 Timothy", "Epistles", [20, 15, 16, 16, 25, 21], 54, ["Protestant", "Catholic", "Orthodox"]),
  "2 Timothy": new BibleBook("New Testament", "2 Timothy", "Epistles", [18, 26, 17, 22], 55, ["Protestant", "Catholic", "Orthodox"]),
  Titus: new BibleBook("New Testament", "Titus", "Epistles", [16, 15, 15], 56, ["Protestant", "Catholic", "Orthodox"]),
  Philemon: new BibleBook("New Testament", "Philemon", "Epistles", [25], 57, ["Protestant", "Catholic", "Orthodox"]),

  // General Epistles (8 books)
  Hebrews: new BibleBook("New Testament", "Hebrews", "Epistles", [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25], 58, ["Protestant", "Catholic", "Orthodox"]),
  James: new BibleBook("New Testament", "James", "Epistles", [27, 26, 18, 17, 20], 59, ["Protestant", "Catholic", "Orthodox"]),
  "1 Peter": new BibleBook("New Testament", "1 Peter", "Epistles", [25, 25, 22, 19, 14], 60, ["Protestant", "Catholic", "Orthodox"]),
  "2 Peter": new BibleBook("New Testament", "2 Peter", "Epistles", [21, 22, 18], 61, ["Protestant", "Catholic", "Orthodox"]),
  "1 John": new BibleBook("New Testament", "1 John", "Epistles", [10, 29, 24, 21, 21], 62, ["Protestant", "Catholic", "Orthodox"]),
  "2 John": new BibleBook("New Testament", "2 John", "Epistles", [13], 63, ["Protestant", "Catholic", "Orthodox"]),
  "3 John": new BibleBook("New Testament", "3 John", "Epistles", [14], 64, ["Protestant", "Catholic", "Orthodox"]),
  Jude: new BibleBook("New Testament", "Jude", "Epistles", [25], 65, ["Protestant", "Catholic", "Orthodox"]),
