        ...
        >
          <div class="card-content">
            ...
            <div class="status-icon" *ngIf="isBookCompleted(book.name) || isBookInProgress(book.name)">
              <svg *ngIf="isBookCompleted(book.name)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="completed-icon">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
              </svg>
              <svg *ngIf="!isBookCompleted(book.name) && isBookInProgress(book.name)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="progress-icon">
